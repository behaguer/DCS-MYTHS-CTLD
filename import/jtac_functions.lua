...
--      			1> Load MIST + CTLD
--                  2> Create a TRIGGER (once) at Time sup Ã  6, and a ACTION.EXECUTE SCRIPT :
--							ctld.JTACAutoLase("gdrone1", 1688,false)  -- dÃ©fine group "gdrone1" as a JTAC
------------------------------------------------------------------------------------
...
function ctld.TreatOrbitJTAC(params, t)
	...
	for k,v in pairs(ctld.jtacUnits) do					-- vÃ©rify state of each active JTAC
